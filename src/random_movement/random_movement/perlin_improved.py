...
https://www.fundza.com/c4serious/noise/perlin/index.html
...
if __name__ == '__main__':
    ...
    # xs = np.arange(100, 150, 0.1)
    xs = np.arange(0, 10, 0.01)
    # noise = PerlinNoise(octaves=0.3, seed=100)
    noise = PerlinNoise(octaves=10, seed=100)
    # ys = noise(xs.tolist())
    ys = []
    for x in xs:
        # ys.append(pnoise(x, 50.5, 10.1))
        ys.append(noise(x))
    ...
    print(np.array(pic).max())
    print(np.array(pic).min())
